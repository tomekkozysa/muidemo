...
2. This is a Sequencer,

Before you use it though, make sure the keyboard is "armed" first. Click the keyboard component, once highlighted it will listen to the keyboard events. 
...
Back to Sequencer, pick a mode/action, start with Record. With that mode selected, you can pick when a note is played, with armed keyboard you can record particular note.
